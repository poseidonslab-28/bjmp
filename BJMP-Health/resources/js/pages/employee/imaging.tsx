...
export default function Imaging({ user }: Props) {
    ...
    const handleViewImage = (imagePath: string, procedure: string) => {
    ...
    return (
        <EmployeeAppSidebarLayout breadcrumbs={[
            ...
            { title: 'Imaging', href: '/employee/imaging' }
        ]}>
                <Head title="Imaging" />
                <div className={`flex bg-gray-100 min-h-screen ${showModal ? 'blur-sm' : ''}`}>
                                            ...
                                            <tbody>                                                <tr className="border-b">
                                                    ...
                                                    <td className="py-3 px-6 flex gap-2">
                                                        <button 
                                                            ...
                                                            onClick={() => handleViewImage('/images/chest-xray-sample.jpg', 'CHEST X-RAY')}
                                                        >
                                                ...
                                                <tr>
                                                    ...
                                                    <td className="py-3 px-6 flex gap-2">
                                                        <button 
                                                            ...
                                                            onMouseEnter={(e) => e.currentTarget.style.backgroundColor = '#2A9D69'} 
                                                            onMouseLeave={(e) => e.currentTarget.style.backgroundColor = '#37B37E'}
                                                            onClick={() => handleViewImage('/images/ecg-sample.jpg', 'ECG')}
                                                        >
                                                            <img src="/icons/view.png" alt="View" className="w-5 h-5" />
                                                        </button>
                                                        <button className="text-white rounded p-2 cursor-pointer" style={{ backgroundColor: '#FFAB01' }} onMouseEnter={(e) => e.currentTarget.style.backgroundColor = '#E69A01'} onMouseLeave={(e) => e.currentTarget.style.backgroundColor = '#FFAB01'}>
                        ...
                        <div className="bg-white rounded-lg shadow-lg max-w-3xl max-h-[90vh] overflow-auto relative">
                            ...
                            <div className="p-6">
                                ...
                                <p className="text-gray-600 mb-4 text-center">
                                    {selectedProcedure} - NOVEMBER 2, 2023
                                </p>
                                
                                <div className="flex justify-center">
                                    <img
                                        src={selectedImage || '/images/default-imaging.jpg'}
                                        alt={`${selectedProcedure} imaging result`}
                                        className="max-w-full h-auto rounded-lg shadow-md"
                                        style={{ maxHeight: '70vh' }}
                                        onError={(e) => {
                                            e.currentTarget.src = '/images/default-imaging.jpg';
                                        }}
                                    />
                                </div>
                            </div>
