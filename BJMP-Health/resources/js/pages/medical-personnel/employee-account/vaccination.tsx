...
export default function Vaccination({ employee, vaccinations }: Props) {
    ...
    return (
        <MedicalAppSidebarLayout breadcrumbs={[{ title: 'Vaccination', href: `/medical/employee-account/vaccination/${employee.Emp_ID}` }]}> 
                    ...
                    <div className="w-full max-w-7xl flex gap-8">
                        ...
                        <div className="w-80 bg-white rounded-xl shadow flex flex-col items-center py-8 px-0 border border-gray-200">
                            ...
                            <div className="w-full flex flex-col gap-2 px-4">
                                ...
                                <Link href={`/medical/employee-account/vaccination/${employee.Emp_ID}`} className="w-full flex items-center gap-3 py-3 px-3 rounded mb-2 font-semibold" style={{ backgroundColor: '#FFAB2E', color: '#000', boxShadow: '0 2px 8px #FFAB2ECC' }}>
                                            ...
                                            {vaccinations && vaccinations.length > 0 ? (
                                                vaccinations.map((vaccination) => (
                                                    <tr key={vaccination.ID} className="border-b">
                                                        ...
                                                        <td className="py-3 px-6">{vaccination.Vaccine}</td>
                                                ...
                                                <tr>
                                                    <td colSpan={3} className="py-8 px-6 text-center text-gray-500">
                                                        No vaccination records found for this employee.
                                                    </td>
                                                </tr>
                                            )}
                                        </tbody>
            ...
            {/* Modal for viewing vaccination details */}
                    ...
                    <div className="bg-white rounded-lg shadow-lg max-w-4xl w-full max-h-[90vh] overflow-y-auto m-4">
                        <div className="p-6">
                            <div className="flex justify-between items-center mb-6">
                                <h2 className="text-2xl font-bold">Vaccination Details</h2>
                                <button
                                    onClick={closeModal}
                                    ...
                                    <div className="space-y-3">
                                        <div>
                                            ...
                                            <div className="text-sm text-gray-900">
                                                {new Date(selectedVaccination.Date).toLocaleDateString('en-US', {
                                                    year: 'numeric',
                                                    month: 'long',
                                                    day: 'numeric'
                                                })}
                                        ...
                                        <div>
                                            ...
                                            <div className="text-sm text-gray-900">{displayValue(selectedVaccination.Vaccine)}</div>
                                        </div>
                                        <div>
                                            <label className="block text-sm font-medium text-gray-700">Venue</label>
                                            <div className="text-sm text-gray-900">{displayValue(selectedVaccination.Venue)}</div>
                                        </div>
                                        <div>
                                            <label className="block text-sm font-medium text-gray-700">Patient ID</label>
                                            <div className="text-sm text-gray-900">{displayValue(selectedVaccination.Patient_ID)}</div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <div className="space-y-3">
                                        <div>
                                            ...
                                            <div className="text-sm text-gray-900">{displayValue(selectedVaccination.Record_ID)}</div>
                                        </div>
                                        <div>
                                            <label className="block text-sm font-medium text-gray-700">File</label>
                                            <div className="text-sm text-gray-900">{displayValue(selectedVaccination.File)}</div>
                                        </div>
                                        <div>
                                            <label className="block text-sm font-medium text-gray-700">Status</label>
                                            <div className="text-sm text-gray-900">
                                                {selectedVaccination.archived ? 'Archived' : 'Active'}
                                            </div>
                                        </div>
                                    </div>
                                </div>
