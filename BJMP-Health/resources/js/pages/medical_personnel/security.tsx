...
export default function Security() {
    ...
    return (
        <AppLayout breadcrumbs={[{ title: 'Security', href: '/medical_personnel/security' }]}> 
            <Head title="Security" />
                    ...
                    <div className="w-full max-w-7xl flex gap-8">
                        ...
                        <div className="w-80 bg-white rounded-xl shadow flex flex-col items-center py-8 px-0 border border-gray-200">
                            ...
                            <div className="w-full flex flex-col gap-2 px-4">
                                ...
                                <Link href="/medical_personnel/security" className="w-full flex items-center gap-3 py-3 px-3 rounded mb-2 font-semibold" style={{ backgroundColor: '#FFAB2E', color: '#000', boxShadow: '0 2px 8px #FFAB2ECC' }}>
