...
export default function Laboratory() {
    return (
        <AppLayout breadcrumbs={[{ title: 'Laboratory', href: '/medical_personnel/laboratory' }]}> 
                    ...
                    <div className="w-full max-w-7xl flex gap-8">
                        ...
                        <div className="w-80 bg-white rounded-xl shadow flex flex-col items-center py-8 px-0 border border-gray-200">
                            ...
                            <div className="w-full flex flex-col gap-2 px-4">
                                ...
                                <Link href="/medical_personnel/laboratory" className="w-full flex items-center gap-3 py-3 px-3 rounded mb-2 font-semibold" style={{ backgroundColor: '#FFAB2E', color: '#000', boxShadow: '0 2px 8px #FFAB2ECC' }}>
                                ...
                                <div className="bg-gray-50 rounded-xl shadow p-0 overflow-x-auto">
                                    <table className="min-w-full">
                                        ...
                                        <tbody>                                            <tr className="border-b">
                                                <td className="py-3 px-6 text-blue-900 font-semibold">JANUARY 30, 2024</td>
                                                <td className="py-3 px-6">ANNUAL MEDICAL EXAMINATION 2024</td>
                                            ...
                                            <tr>
                                                ...
                                                <td className="py-3 px-6">ANNUAL MEDICAL EXAMINATION 2023</td>
                                                <td className="py-3 px-6 flex gap-2">
                                                    <button className="text-white rounded p-2" style={{ backgroundColor: '#37B37E' }} onMouseEnter={(e) => e.currentTarget.style.backgroundColor = '#2A9D69'} onMouseLeave={(e) => e.currentTarget.style.backgroundColor = '#37B37E'}>
                                                        <img src="/icons/view.png" alt="View" className="w-5 h-5" />
                                                    </button>
